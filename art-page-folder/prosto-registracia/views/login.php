            ...
            <main class="form-signin  py-5">
                ...
                <form method="POST" action="?login">
                    ...
                    <div class="form-floating">
                        ...
                        <label for="pass floatingPassword">Пароль:</label>
                    </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <a href="?recovery" class="text-dark">Забыли пароль?</a>
                        </div>
                        <div class="col">
                            <a href="?signup" class="text-dark">Регистрация</a>
                        </div>
                    </div>
                </form>
            </main>
