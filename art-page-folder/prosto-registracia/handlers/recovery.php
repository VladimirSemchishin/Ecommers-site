...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ){
  ...
  if ($stmt = mysqli_prepare($db, $query)) {
    ...
    $msg = "Если эта не Ваша попытка восстановить пароль, проигнорируйте это сообщение. Если Вы пытаетесь восстановить пароль, нажмите на <a href=\"http://{$_SERVER['SERVER_NAME']}/art-page-folder/prosto-registracia/index.php?recovery_token=" . $recovery_token . "\">ссылку</a> для установки нового пароля";  
