...
if (mysqli_stmt_prepare($stmt, $query)) {
  ...
  $msg = "Нажмите на <a href=\"http://{$_SERVER['SERVER_NAME']}/art-page-folder/prosto-registracia/index.php?confirmation_token=" . $confirmation_token . "\">ссылку</a> для подтверждения email";  
